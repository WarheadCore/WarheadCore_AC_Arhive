...
public:
    ...
    struct boss_romuloAI : public ScriptedAI
    {
        ...
        void DamageTaken(Unit* /*done_by*/, uint32 &damage) override
        {
            ...
            WC_LOG_ERROR("scripts", "boss_romuloAI: DamageTaken reach end of code, that should not happen.");
        }
...
void boss_julianne::boss_julianneAI::DamageTaken(Unit* /*done_by*/, uint32 &damage)
{
    ...
    if (Phase == PHASE_ROMULO)
    {
        WC_LOG_ERROR("scripts", "boss_julianneAI: cannot take damage in PHASE_ROMULO, why was i here?");
        damage = 0;
        return;
    }
    ...
    WC_LOG_ERROR("scripts", "boss_julianneAI: DamageTaken reach end of code, that should not happen.");
}

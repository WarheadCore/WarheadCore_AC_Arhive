...
class WC_SHARED_API ByteBufferException : public std::exception
{
public:
...
class WC_SHARED_API ByteBufferPositionException : public ByteBufferException
{
public:
...
class WC_SHARED_API ByteBufferSourceException : public ByteBufferException
{
public:
...
class WC_SHARED_API ByteBuffer
{
    public:

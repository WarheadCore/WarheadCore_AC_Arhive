...
namespace Crypto
{
    ...
    void AEEncryptWithRandomIV(std::vector<uint8>& data, typename Cipher::Key const& key)
    {
        ...
        // select random IV
        IV iv = Impl::CryptoGenericsImpl::GenerateRandomIV<Cipher>();
        Tag tag;
        ...
        Impl::CryptoGenericsImpl::AppendToBack(data, iv);
        Impl::CryptoGenericsImpl::AppendToBack(data, tag);
    }
    ...
    bool AEDecrypt(std::vector<uint8>& data, typename Cipher::Key const& key)
    {
        ...
        IV iv;
        Tag tag;
        Impl::CryptoGenericsImpl::SplitFromBack(data, tag);
        Impl::CryptoGenericsImpl::SplitFromBack(data, iv);

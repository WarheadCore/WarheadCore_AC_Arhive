...
#define VMAP_ERROR_LOG(FILTER, ...) WC_LOG_ERROR(FILTER, __VA_ARGS__)
#define VMAP_DEBUG_LOG(FILTER, ...) WC_LOG_DEBUG(FILTER, __VA_ARGS__)
#define VMAP_INFO_LOG(FILTER, ...) WC_LOG_INFO(FILTER, __VA_ARGS__)
#else

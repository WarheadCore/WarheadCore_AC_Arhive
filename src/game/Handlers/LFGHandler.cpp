...
void WorldSession::HandleLfgJoinOpcode(WorldPacket& recvData)
{
    ...
    if (!numDungeons)
    {
        WC_LOG_DEBUG("lfg", "CMSG_LFG_JOIN %s no dungeons selected", GetPlayerInfo().c_str());
        recvData.rfinish();
        return;
    }
    ...
    std::string comment;
    recvData >> comment;
    WC_LOG_DEBUG("lfg", "CMSG_LFG_JOIN %s roles: %u, Dungeons: %u, Comment: %s",
...
void WorldSession::HandleLfgLeaveOpcode(WorldPacket&  /*recvData*/)
{
    ...
    WC_LOG_DEBUG("lfg", "CMSG_LFG_LEAVE %s in group: %u",
...
void WorldSession::HandleLfgProposalResultOpcode(WorldPacket& recvData)
{
    ...
    WC_LOG_DEBUG("lfg", "CMSG_LFG_PROPOSAL_RESULT %s proposal: %u accept: %u",
...
void WorldSession::HandleLfgSetRolesOpcode(WorldPacket& recvData)
{
    ...
    if (!group)
    {
        WC_LOG_DEBUG("lfg", "CMSG_LFG_SET_ROLES %s Not in group",
            GetPlayerInfo().c_str());
        return;
    }
    ObjectGuid gguid = group->GetGUID();
    WC_LOG_DEBUG("lfg", "CMSG_LFG_SET_ROLES: Group %s, Player %s, Roles: %u",
...
void WorldSession::HandleLfgSetCommentOpcode(WorldPacket&  recvData)
{
    ...
    WC_LOG_DEBUG("lfg", "CMSG_LFG_SET_COMMENT %s comment: %s",
...
void WorldSession::HandleLfgSetBootVoteOpcode(WorldPacket& recvData)
{
    ...
    ObjectGuid guid = GetPlayer()->GetGUID();
    WC_LOG_DEBUG("lfg", "CMSG_LFG_SET_BOOT_VOTE %s agree: %u",
...
void WorldSession::HandleLfgTeleportOpcode(WorldPacket& recvData)
{
    ...
    WC_LOG_DEBUG("lfg", "CMSG_LFG_TELEPORT %s out: %u",
...
{
    ObjectGuid guid = GetPlayer()->GetGUID();
    WC_LOG_DEBUG("lfg", "CMSG_LFG_PLAYER_LOCK_INFO_REQUEST %s",
        GetPlayerInfo().c_str());
    ...
    WC_LOG_DEBUG("lfg", "SMSG_LFG_PLAYER_INFO %s", GetPlayerInfo().c_str());
...
{
    ObjectGuid guid = GetPlayer()->GetGUID();
    WC_LOG_DEBUG("lfg", "CMSG_LFG_PARTY_LOCK_INFO_REQUEST %s", GetPlayerInfo().c_str());
    ...
    WC_LOG_DEBUG("lfg", "SMSG_LFG_PARTY_INFO %s", GetPlayerInfo().c_str());
...
void WorldSession::HandleLfrJoinOpcode(WorldPacket& recvData)
{
    ...
    recvData >> entry;
    WC_LOG_DEBUG("lfg", "CMSG_LFG_LFR_JOIN %s dungeon entry: %u",
...
void WorldSession::HandleLfrLeaveOpcode(WorldPacket& recvData)
{
    ...
    recvData >> dungeonId;
    WC_LOG_DEBUG("lfg", "CMSG_LFG_LFR_LEAVE %s dungeonId: %u",
...
{
    WC_LOG_DEBUG("lfg", "CMSG_LFG_GET_STATUS %s", GetPlayerInfo().c_str());
...
void WorldSession::SendLfgUpdatePlayer(lfg::LfgUpdateData const& updateData)
{
    ...
    WC_LOG_DEBUG("lfg", "SMSG_LFG_UPDATE_PLAYER %s updatetype: %u",
...
void WorldSession::SendLfgUpdateParty(const lfg::LfgUpdateData& updateData)
{
    ...
    WC_LOG_DEBUG("lfg", "SMSG_LFG_UPDATE_PARTY %s updatetype: %u",
        GetPlayerInfo().c_str(), updateData.updateType);
...
{
    WC_LOG_DEBUG("lfg", "SMSG_LFG_ROLE_CHOSEN %s guid: %s roles: %u",
...
void WorldSession::SendLfgRoleCheckUpdate(lfg::LfgRoleCheck const& roleCheck)
{
    ...
    WC_LOG_DEBUG("lfg", "SMSG_LFG_ROLE_CHECK_UPDATE %s", GetPlayerInfo().c_str());
...
void WorldSession::SendLfgJoinResult(lfg::LfgJoinResultData const& joinData)
{
    ...
    WC_LOG_DEBUG("lfg", "SMSG_LFG_JOIN_RESULT %s checkResult: %u checkValue: %u",
...
{
    WC_LOG_DEBUG("lfg", "SMSG_LFG_QUEUE_STATUS %s state: %s, dungeon: %u, waitTime: %d, "
...
void WorldSession::SendLfgPlayerReward(lfg::LfgPlayerRewardData const& rewardData)
{
    ...
    WC_LOG_DEBUG("lfg", "SMSG_LFG_PLAYER_REWARD %s rdungeonEntry: %u, sdungeonEntry: %u, done: %u",
...
void WorldSession::SendLfgBootProposalUpdate(lfg::LfgPlayerBoot const& boot)
{
    ...
    WC_LOG_DEBUG("lfg", "SMSG_LFG_BOOT_PROPOSAL_UPDATE %s inProgress: %u - "
...
void WorldSession::SendLfgUpdateProposal(lfg::LfgProposal const& proposal)
{
    ...
    WC_LOG_DEBUG("lfg", "SMSG_LFG_PROPOSAL_UPDATE %s state: %u",
...
{
    WC_LOG_DEBUG("lfg", "SMSG_LFG_LFR_LIST %s update: %u",
...
{
    WC_LOG_DEBUG("lfg", "SMSG_LFG_DISABLED %s", GetPlayerInfo().c_str());
...
{
    WC_LOG_DEBUG("lfg", "SMSG_LFG_OFFER_CONTINUE %s dungeon entry: %u",
...
{
    WC_LOG_DEBUG("lfg", "SMSG_LFG_TELEPORT_DENIED %s reason: %u",
...
{
    WC_LOG_DEBUG("network", "SMSG_LFG_UPDATE_LIST %s dungeon entry: %u",
        GetPlayerInfo().c_str(), dungeonEntry);

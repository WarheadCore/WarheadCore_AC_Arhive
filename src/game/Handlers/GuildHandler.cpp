...
void WorldSession::HandleGuildQueryOpcode(WorldPacket& recvPacket)
{
    ...
    WC_LOG_DEBUG("guild", "CMSG_GUILD_QUERY [%s]: Guild: %u", GetPlayerInfo().c_str(), guildId);
    if (!guildId)
        return;
...
void WorldSession::HandleGuildCreateOpcode(WorldPacket& recvPacket)
{
    ...
    WC_LOG_ERROR("entities.player.cheat", "CMSG_GUILD_CREATE: Possible hacking-attempt: %s tried to create a guild [Name: %s] using cheats", GetPlayerInfo().c_str(), name.c_str());
}
...
void WorldSession::HandleGuildInviteOpcode(WorldPacket& recvPacket)
{
    ...
    WC_LOG_DEBUG("guild", "CMSG_GUILD_INVITE [%s]: Invited: %s", GetPlayerInfo().c_str(), invitedName.c_str());
...
void WorldSession::HandleGuildRemoveOpcode(WorldPacket& recvPacket)
{
    ...
    WC_LOG_DEBUG("guild", "CMSG_GUILD_REMOVE [%s]: Target: %s", GetPlayerInfo().c_str(), playerName.c_str());
...
{
    WC_LOG_DEBUG("guild", "CMSG_GUILD_ACCEPT [%s]", GetPlayer()->GetName().c_str());
...
{
    WC_LOG_DEBUG("guild", "CMSG_GUILD_DECLINE [%s]", GetPlayerInfo().c_str());
...
{
    WC_LOG_DEBUG("guild", "CMSG_GUILD_INFO [%s]", GetPlayerInfo().c_str());
...
{
    WC_LOG_DEBUG("guild", "CMSG_GUILD_ROSTER [%s]", GetPlayerInfo().c_str());
...
void WorldSession::HandleGuildPromoteOpcode(WorldPacket& recvPacket)
{
    ...
    WC_LOG_DEBUG("guild", "CMSG_GUILD_PROMOTE [%s]: Target: %s", GetPlayerInfo().c_str(), playerName.c_str());
...
void WorldSession::HandleGuildDemoteOpcode(WorldPacket& recvPacket)
{
    ...
    WC_LOG_DEBUG("guild", "CMSG_GUILD_DEMOTE [%s]: Target: %s", GetPlayerInfo().c_str(), playerName.c_str());
...
{
    WC_LOG_DEBUG("guild", "CMSG_GUILD_LEAVE [%s]", GetPlayerInfo().c_str());
...
{
    WC_LOG_DEBUG("guild", "CMSG_GUILD_DISBAND [%s]", GetPlayerInfo().c_str());
...
void WorldSession::HandleGuildLeaderOpcode(WorldPacket& recvPacket)
{
    ...
    WC_LOG_DEBUG("guild", "CMSG_GUILD_LEADER [%s]: Target: %s", GetPlayerInfo().c_str(), name.c_str());
...
void WorldSession::HandleGuildMOTDOpcode(WorldPacket& recvPacket)
{
    ...
    WC_LOG_DEBUG("guild", "CMSG_GUILD_MOTD [%s]: MOTD: %s", GetPlayerInfo().c_str(), motd.c_str());
...
void WorldSession::HandleGuildSetPublicNoteOpcode(WorldPacket& recvPacket)
{
    ...
    WC_LOG_DEBUG("guild", "CMSG_GUILD_SET_PUBLIC_NOTE [%s]: Target: %s, Note: %s",
...
void WorldSession::HandleGuildSetOfficerNoteOpcode(WorldPacket& recvPacket)
{
    ...
    WC_LOG_DEBUG("guild", "CMSG_GUILD_SET_OFFICER_NOTE [%s]: Target: %s, Note: %s",
         GetPlayerInfo().c_str(), playerName.c_str(), note.c_str());
...
void WorldSession::HandleGuildRankOpcode(WorldPacket& recvPacket)
{
    ...
    WC_LOG_DEBUG("guild", "CMSG_GUILD_RANK [%s]: Rank: %s (%u)", GetPlayerInfo().c_str(), rankName.c_str(), rankId);
...
void WorldSession::HandleGuildAddRankOpcode(WorldPacket& recvPacket)
{
    ...
    WC_LOG_DEBUG("guild", "CMSG_GUILD_ADD_RANK [%s]: Rank: %s", GetPlayerInfo().c_str(), rankName.c_str());
...
{
    WC_LOG_DEBUG("guild", "CMSG_GUILD_DEL_RANK [%s]", GetPlayerInfo().c_str());
...
void WorldSession::HandleGuildChangeInfoTextOpcode(WorldPacket& recvPacket)
{
    ...
    WC_LOG_DEBUG("guild", "CMSG_GUILD_INFO_TEXT [%s]: %s", GetPlayerInfo().c_str(), info.c_str());
...
void WorldSession::HandleSaveGuildEmblemOpcode(WorldPacket& recvPacket)
{
    ...
    WC_LOG_DEBUG("guild", "MSG_SAVE_GUILD_EMBLEM [%s]: Guid: [%s] Style: %d, Color: %d, BorderStyle: %d, BorderColor: %d, BackgroundColor: %d"
...
{
    WC_LOG_DEBUG("guild", "MSG_GUILD_EVENT_LOG_QUERY [%s]", GetPlayerInfo().c_str());
...
{
    WC_LOG_DEBUG("guild", "MSG_GUILD_BANK_MONEY_WITHDRAWN [%s]", GetPlayerInfo().c_str());
...
{
    WC_LOG_DEBUG("guild", "MSG_GUILD_PERMISSIONS [%s]", GetPlayerInfo().c_str());
...
void WorldSession::HandleGuildBankerActivate(WorldPacket& recvData)
{
    ...
    WC_LOG_DEBUG("guild", "CMSG_GUILD_BANKER_ACTIVATE [%s]: [%s] AllSlots: %u"
...
void WorldSession::HandleGuildBankQueryTab(WorldPacket& recvData)
{
    ...
    WC_LOG_DEBUG("guild", "CMSG_GUILD_BANK_QUERY_TAB [%s]: %s, TabId: %u, ShowTabs: %u"
...
void WorldSession::HandleGuildBankDepositMoney(WorldPacket& recvData)
{
    ...
    WC_LOG_DEBUG("guild", "CMSG_GUILD_BANK_DEPOSIT_MONEY [%s]: [%s], money: %u",
...
void WorldSession::HandleGuildBankWithdrawMoney(WorldPacket& recvData)
{
    ...
    WC_LOG_DEBUG("guild", "CMSG_GUILD_BANK_WITHDRAW_MONEY [%s]: [%s], money: %u",
        GetPlayerInfo().c_str(), guid.ToString().c_str(), money);
...
{
    WC_LOG_DEBUG("guild", "CMSG_GUILD_BANK_SWAP_ITEMS [%s]", GetPlayerInfo().c_str());
...
void WorldSession::HandleGuildBankBuyTab(WorldPacket& recvData)
{
    ...
    WC_LOG_DEBUG("guild", "CMSG_GUILD_BANK_BUY_TAB [%s]: [%s[, TabId: %u", GetPlayerInfo().c_str(), guid.ToString().c_str(), tabId);
...
void WorldSession::HandleGuildBankUpdateTab(WorldPacket& recvData)
{
    ...
    WC_LOG_DEBUG("guild", "CMSG_GUILD_BANK_UPDATE_TAB [%s]: [%s], TabId: %u, Name: %s, Icon: %s"
...
void WorldSession::HandleGuildBankLogQuery(WorldPacket& recvData)
{
    ...
    WC_LOG_DEBUG("guild", "MSG_GUILD_BANK_LOG_QUERY [%s]: TabId: %u", GetPlayerInfo().c_str(), tabId);
...
void WorldSession::HandleQueryGuildBankTabText(WorldPacket &recvData)
{
    ...
    WC_LOG_DEBUG("guild", "MSG_QUERY_GUILD_BANK_TEXT [%s]: TabId: %u", GetPlayerInfo().c_str(), tabId);
...
void WorldSession::HandleSetGuildBankTabText(WorldPacket &recvData)
{
    ...
    WC_LOG_DEBUG("guild", "CMSG_SET_GUILD_BANK_TEXT [%s]: TabId: %u, Text: %s", GetPlayerInfo().c_str(), tabId, text.c_str());

...
namespace DisableMgr
{
    ...
    void LoadDisables()
    {
        ...
        if (!result)
        {
            LOG_WARN("sql.sql", ">> Loaded 0 disables. DB table `disables` is empty!");
            LOG_WARN("sql.sql", "");
            return;
        }
        ...
        LOG_INFO("disable", ">> Loaded %u disables in %u ms", total_count, GetMSTimeDiffToNow(oldMSTime));
        LOG_INFO("disable", "");
    }
    ...
    void CheckQuestDisables()
    {
        ...
        if (!count)
        {
            LOG_INFO("disable", ">> Checked 0 quest disables.");
            LOG_INFO("disable", "");
            return;
        }
        ...
        LOG_INFO("disable", ">> Checked %u quest disables in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
        LOG_INFO("disable", "");
    }

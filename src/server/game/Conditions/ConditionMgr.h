...
{                                                                // value1           value2         value3
    ...
    CONDITION_QUEST_SATISFY_EXCLUSIVE    = 41,                   // quest_id         0              0                  true if satisfied exclusive group
    CONDITION_HAS_AURA_TYPE              = 42,                   // aura_type        0              0                  true if has aura type
    CONDITION_QUEST_OBJECTIVE_PROGRESS   = 43,

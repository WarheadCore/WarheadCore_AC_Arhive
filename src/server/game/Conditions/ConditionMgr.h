...
{                                                              // value1           value2         value3
    ...
    CONDITION_OBJECT_ENTRY_GUID_MASTER = 50,                   // TypeID           entry          guid               true if object is type TypeID and the entry is 0 or matches entry of the object or matches guid of the object using master branch TypeID
    CONDITION_TYPE_MASK_MASTER         = 51,                   // TypeMask         0              0                  true if object is type object's TypeMask matches provided TypeMask using master branch TypeMask
    CONDITION_MAX
};

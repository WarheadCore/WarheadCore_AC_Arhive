...
void GuildMgr::LoadGuilds()
{
    ...
    LOG_INFO("server.loading", "Loading guilds definitions...");
    {
        ...
        if (!result)
        {
            LOG_WARN("sql.sql", ">> Loaded 0 guild definitions. DB table `guild` is empty.");
            LOG_WARN("sql.sql", "");
        }
        else
        {
    ...
    LOG_INFO("server.loading", "Loading guild ranks...");
    {
        ...
        if (!result)
        {
            LOG_WARN("sql.sql", ">> Loaded 0 guild ranks. DB table `guild_rank` is empty.");
            LOG_WARN("sql.sql", "");
        }
        else
        {
    ...
    LOG_INFO("server.loading", "Loading guild members...");
    {
        ...
        if (!result)
        {
            LOG_WARN("sql.sql", ">> Loaded 0 guild members. DB table `guild_member` is empty.");
            LOG_WARN("sql.sql", "");
        }
        else
        {
    ...
    LOG_INFO("server.loading", "Loading bank tab rights...");
    {
        ...
        if (!result)
        {
            LOG_WARN("sql.sql", ">> Loaded 0 guild bank tab rights. DB table `guild_bank_right` is empty.");
            LOG_WARN("sql.sql", "");
        }
        else
        {
    ...
    LOG_INFO("server.loading", "Loading guild event logs...");
    {
        ...
        if (!result)
        {
            LOG_WARN("sql.sql", ">> Loaded 0 guild event logs. DB table `guild_eventlog` is empty.");
            LOG_WARN("sql.sql", "");
        }
        else
        {
    ...
    LOG_INFO("server.loading", "Loading guild bank event logs...");
    {
        ...
        if (!result)
        {
            LOG_WARN("sql.sql", ">> Loaded 0 guild bank event logs. DB table `guild_bank_eventlog` is empty.");
            LOG_WARN("sql.sql", "");
        }
        else
        {
    ...
    LOG_INFO("server.loading", "Loading guild bank tabs...");
    {
        ...
        if (!result)
        {
            LOG_WARN("sql.sql", ">> Loaded 0 guild bank tabs. DB table `guild_bank_tab` is empty.");
            LOG_WARN("sql.sql", "");
        }
        else
        {
    ...
    LOG_INFO("server.loading", "Filling bank tabs with items...");
    {
        ...
        if (!result)
        {
            LOG_WARN("sql.sql", ">> Loaded 0 guild bank tab items. DB table `guild_bank_item` or `item_instance` is empty.");
            LOG_WARN("sql.sql", "");
        }
        else
        {

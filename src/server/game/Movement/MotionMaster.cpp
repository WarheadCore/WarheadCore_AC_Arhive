...
void MotionMaster::MoveRandom(float wanderDistance)
{
    ...
    {
        LOG_DEBUG("movement.motionmaster", "Creature (GUID: %u) start moving random", _owner->GetGUIDLow());
...
void MotionMaster::MoveTargetedHome()
{
    ...
    {
        LOG_DEBUG("movement.motionmaster", "Creature (Entry: %u GUID: %u) targeted home", _owner->GetEntry(), _owner->GetGUIDLow());
    ...
    else if (_owner->GetTypeId() == TYPEID_UNIT && _owner->ToCreature()->GetCharmerOrOwnerGUID())
    {
        ...
        LOG_DEBUG("movement.motionmaster", "Pet or controlled creature (Entry: %u GUID: %u) targeting home", _owner->GetEntry(), _owner->GetGUIDLow());
        Unit* target = _owner->ToCreature()->GetCharmerOrOwner();
        if (target)
        {
            LOG_DEBUG("movement.motionmaster", "Following %s (GUID: %u)", target->GetTypeId() == TYPEID_PLAYER ? "player" : "creature", target->GetTypeId() == TYPEID_PLAYER ? target->GetGUIDLow() : ((Creature*)target)->GetDBTableGUIDLow());
...
void MotionMaster::MoveConfused()
{
    ...
    if (_owner->GetTypeId() == TYPEID_PLAYER)
    {
        LOG_DEBUG("movement.motionmaster", "Player (GUID: %u) move confused", _owner->GetGUIDLow());
        Mutate(new ConfusedMovementGenerator<Player>(), MOTION_SLOT_CONTROLLED);
    }
    else
    {
        LOG_DEBUG("movement.motionmaster", "Creature (Entry: %u GUID: %u) move confused", _owner->GetEntry(), _owner->GetGUIDLow());
...
void MotionMaster::MoveChase(Unit* target, float dist, float angle)
{
    ...
    if (_owner->GetTypeId() == TYPEID_PLAYER)
    {
        LOG_DEBUG("movement.motionmaster", "Player (GUID: %u) chase to %s (GUID: %u)",
            _owner->GetGUIDLow(),
    ...
    {
        LOG_DEBUG("movement.motionmaster", "Creature (Entry: %u GUID: %u) chase to %s (GUID: %u)",
...
void MotionMaster::MoveFollow(Unit* target, float dist, float angle, MovementSlot slot)
{
    ...
    if (_owner->GetTypeId() == TYPEID_PLAYER)
    {
        LOG_DEBUG("movement.motionmaster", "Player (GUID: %u) follow to %s (GUID: %u)", _owner->GetGUIDLow(),
            target->GetTypeId() == TYPEID_PLAYER ? "player" : "creature",
            target->GetTypeId() == TYPEID_PLAYER ? target->GetGUIDLow() : target->ToCreature()->GetDBTableGUIDLow());
    ...
    {
        LOG_DEBUG("movement.motionmaster", "Creature (Entry: %u GUID: %u) follow to %s (GUID: %u)",
            _owner->GetEntry(), _owner->GetGUIDLow(),
            target->GetTypeId() == TYPEID_PLAYER ? "player" : "creature",
            target->GetTypeId() == TYPEID_PLAYER ? target->GetGUIDLow() : target->ToCreature()->GetDBTableGUIDLow());
...
{
    LOG_DEBUG("movement.motionmaster", "Unit (GUID: %u) jump to point (X: %f Y: %f Z: %f)", _owner->GetGUIDLow(), x, y, z);
...
void MotionMaster::MoveFleeing(Unit* enemy, uint32 time)
{
    ...
    if (_owner->GetTypeId() == TYPEID_PLAYER)
    {
        LOG_DEBUG("movement.motionmaster", "Player (GUID: %u) flee from %s (GUID: %u)", _owner->GetGUIDLow(),
    ...
    {
        LOG_DEBUG("movement.motionmaster", "Creature (Entry: %u GUID: %u) flee from %s (GUID: %u)%s",
            _owner->GetEntry(), _owner->GetGUIDLow(),
            enemy->GetTypeId() == TYPEID_PLAYER ? "player" : "creature",
            enemy->GetTypeId() == TYPEID_PLAYER ? enemy->GetGUIDLow() : enemy->ToCreature()->GetDBTableGUIDLow(),
...
void MotionMaster::MoveTaxiFlight(uint32 path, uint32 pathnode)
{
    ...
    {
        LOG_ERROR("movement.motionmaster", "Creature (Entry: %u GUID: %u) attempt taxi to (Path %u node %u)",
...
void MotionMaster::MovePath(uint32 path_id, bool repeatable)
{
    ...
    LOG_DEBUG("movement.motionmaster", "%s (GUID: %u) start moving over path(Id:%u, repeatable: %s)",

...
void WorldSession::HandleGroupUninviteGuidOpcode(WorldPacket& recvData)
{
    ...
    {
        LOG_ERROR("network.opcode", "WorldSession::HandleGroupUninviteGuidOpcode: leader %s(%d) tried to uninvite himself from the group.", GetPlayer()->GetName().c_str(), GetPlayer()->GetGUIDLow());
        return;
    }
...
void WorldSession::HandleGroupUninviteOpcode(WorldPacket& recvData)
{
    ...
    {
        LOG_ERROR("network.opcode", "WorldSession::HandleGroupUninviteOpcode: leader %s(%d) tried to uninvite himself from the group.", GetPlayer()->GetName().c_str(), GetPlayer()->GetGUIDLow());
        return;
    }

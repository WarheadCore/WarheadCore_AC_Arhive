    ...
    struct npc_highlord_darion_mograineAI : public ScriptedAI
    {
        ...
        void DoAction(int32 param) override
        {
            if (param == ACTION_START_EVENT && !startTimeRemaining && events.Empty())
            {
                ...
                events.Reset();
                events.ScheduleEvent(EVENT_START_COUNTDOWN_1, 1min);
                events.ScheduleEvent(EVENT_START_COUNTDOWN_2, 2min);
                events.ScheduleEvent(EVENT_START_COUNTDOWN_3, 3min);
                events.ScheduleEvent(EVENT_START_COUNTDOWN_4, 4min);
                events.ScheduleEvent(EVENT_START_COUNTDOWN_5, 5min);
                ...
                events.ScheduleEvent(EVENT_START_COUNTDOWN_13, 337s);
        ...
        void EnterCombat(Unit*) override
        {
            ...
            events.RescheduleEvent(EVENT_SPELL_TALK, 10s);
        }
        ...
        void MovementInform(uint32 type, uint32 point) override
        {
            if (type == POINT_MOTION_TYPE && point == 2)
            {
                ...
                events.ScheduleEvent(EVENT_OUTRO_SCENE_17, 2min);
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            switch (eventId)
            {
                ...
                case EVENT_OUTRO_SCENE_19:
                    ...
                    events.ScheduleEvent(EVENT_OUTRO_SCENE_21, 4500ms);
                    ...
                    events.ScheduleEvent(EVENT_OUTRO_SCENE_25, 21200ms);
                    events.ScheduleEvent(EVENT_OUTRO_SCENE_26, 22500ms);
            ...
            switch (eventId)
            {
                ...
                case EVENT_SPELL_UNHOLY_BLIGHT:
                    ...
                    events.RescheduleEvent(eventId, 1min);
                    break;

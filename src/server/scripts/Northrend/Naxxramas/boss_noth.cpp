        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            switch (events.GetEvent())
            {
                ...
                case EVENT_SUMMON_PLAGUED_WARRIOR_REAL:
                    ...
                    SummonHelper(NPC_PLAGUED_WARRIOR, RAID_MODE(2, 3, 2, 3));
                    events.PopEvent();
                    break;
                ...
                case EVENT_BALCONY_SUMMON_REAL:
                    ...
                    if (events.GetPhaseMask() == 0)
                        SummonHelper(NPC_PLAGUED_CHAMPION, RAID_MODE(2, 4, 2, 4));
                    else if (events.GetPhaseMask() == 1)
                    {
                        SummonHelper(NPC_PLAGUED_CHAMPION, RAID_MODE(1, 2, 1, 2));
                        SummonHelper(NPC_PLAGUED_GUARDIAN, RAID_MODE(1, 2, 1, 2));
                    }
                    else
                        SummonHelper(NPC_PLAGUED_GUARDIAN, RAID_MODE(2, 4, 2, 4));
                    events.PopEvent();
                    break;

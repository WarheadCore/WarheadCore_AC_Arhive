        ...
        void UpdateAI(uint32 diff)
        {
            ...
            switch (events.ExecuteEvent())
            {
                ...
                case EVENT_SUMMON_SHAMBLING_HORROR:
                    ...
                    me->GetMap()->SetZoneMusic(AREA_THE_FROZEN_THRONE, MUSIC_SPECIAL);
                    events.ScheduleEvent(EVENT_SUMMON_SHAMBLING_HORROR, 1min, EVENT_GROUP_ABILITIES);
                    break;
                ...
                case EVENT_PAIN_AND_SUFFERING:
                    ...
                    events.ScheduleEvent(EVENT_PAIN_AND_SUFFERING, (IsHeroic() ? randtime(1250ms, 1750ms) : randtime(1750ms, 2250ms)), EVENT_GROUP_ABILITIES);
                    break;
                ...
                case EVENT_DEFILE:
                    {
                        ...
                        if (evTime && (events.GetTimer() > evTime || evTime - events.GetTimer() < 5000))
                        {
                            ...
                            if (events.GetTimer() > evTime || evTime - events.GetTimer() < 3500)
                            {
                                ...
                                events.ScheduleEvent(EVENT_DEFILE, Milliseconds(t + (Is25ManRaid() ? 5000 : 4000)), EVENT_GROUP_ABILITIES);
                                break;
                            }
        ...
        void MovementInform(uint32 type, uint32 id)
        {
            ...
            switch (id)
            {
                ...
                case POINT_TIRION_OUTRO:
                    _events.ScheduleEvent(EVENT_OUTRO_FORDRING_JUMP, 10ms);
                    break;
            }
        }

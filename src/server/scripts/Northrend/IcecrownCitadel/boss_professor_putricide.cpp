        ...
        struct boss_professor_putricideAI : public BossAI
        {
            ...
            void ChangePhase()
            {
                ...
                switch (_phase)
                {
                    case 1:
                        _phase = 2;
                        events.ScheduleEvent(EVENT_MALLEABLE_GOO, 25s + heroicDelay, 28s + heroicDelay, EVENT_GROUP_ABILITIES);
                        events.ScheduleEvent(EVENT_CHOKING_GAS_BOMB, 35s + heroicDelay, 40s + heroicDelay, EVENT_GROUP_ABILITIES);
                        break;
                    case 2:
                        _phase = 3;

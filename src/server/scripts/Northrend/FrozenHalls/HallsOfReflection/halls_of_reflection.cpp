        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            switch(events.ExecuteEvent())
            {
                ...
                case EVENT_START_INTRO:
                    ...
                    events.ScheduleEvent(me->GetEntry() == NPC_JAINA_PART1 ? EVENT_INTRO_A2_1 : EVENT_INTRO_H2_2, 10s);
                    break;
            ...
            // A2 Intro Events
                ...
                case EVENT_INTRO_A2_13:
                    ...
                    events.ScheduleEvent(EVENT_INTRO_A2_14, 12500ms);
                    break;
            ...
            // H2 Intro Events
                ...
                case EVENT_INTRO_H2_11:
                    ...
                    events.ScheduleEvent(EVENT_INTRO_H2_12, 19500ms);
                    break;
        ...
        void UpdateAI(uint32 diff)
        {
            ...
            switch(events.ExecuteEvent())
            {
                ...
                case EVENT_LK_SUMMON:
                    ...
                    {
                        case 0:
                            events.ScheduleEvent(EVENT_LK_SUMMON_GHOULS, 0s);
                            events.ScheduleEvent(EVENT_LK_SUMMON_RWD, 4s);
                            break;
                        case 1:
                            events.ScheduleEvent(EVENT_LK_SUMMON_LA, 0s);
                        ...
                        case 3:
                            ...
                            events.ScheduleEvent(EVENT_LK_SUMMON_GHOULS, 12500ms);
                            events.ScheduleEvent(EVENT_LK_SUMMON_LA, 16500ms);
                            events.ScheduleEvent(EVENT_LK_SUMMON_RWD, 16600ms);
                            events.ScheduleEvent(EVENT_LK_SUMMON_LA, 17700ms);
                            break;
                    }
                    if (currentWall <= 3)
                    {
...
public:
    ...
    struct npc_hor_leader_secondAI : public NullCreatureAI
    {
        ...
        void DoAction(int32 actionId) override
        {
            ...
            {
                case ACTION_START_INTRO:
                    events.ScheduleEvent(EVENT_LK_SAY_AGGRO, 0s);
                    break;
                case ACTION_START_LK_FIGHT_REAL:
                    events.ScheduleEvent(EVENT_START_RUN, 0s);
                    break;

    ...
    public:
        ...
        struct socretharAI : public ScriptedAI
        {
            ...
            void DoAction(int32 param) override
            {
                switch (param)
                {
                    ...
                    case EVENT_END_ALDOR_FIGHT:
                        _actionEvents.ScheduleEvent(EVENT_END_ALDOR_FIGHT, 10ms);
                        break;
            ...
            void EnterCombat(Unit* /*who*/) override
            {
                ...
                combatEvents.ScheduleEvent(EVENT_SPELL_NETHER_PROTECTION, 10ms);
            }
...
class kaylaan_the_lost : public CreatureScript
{
    public:
        ...
        struct kaylaan_the_lostAI : public ScriptedAI
        {
            ...
            void EnterCombat(Unit* /*who*/) override
            {
                _events.ScheduleEvent(EVENT_SPELL_BURNING_LIGHT, 3s);
